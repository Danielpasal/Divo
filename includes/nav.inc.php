...
$MenuItems = array(
    'gebruiker' => array(
        'Stemmen' => 'login.burger',
        'Registreren' => 'registratie.burger',
        'Login Admin/Beheerders' => 'login.gebruikers',
    ), 'burger' => array(
        'Stemmen doe je hier' => 'stem',
    ),
    'admin' => array(
        'Beheer partijen' => 'beheer.partijen',
        'Beheer beheerders' => 'beheer.beheerders',
        'Beheer inactieve leden' =>'beheer.inactieve.leden'
    ),
    'beheerder' => array(
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#">Divo</a>
